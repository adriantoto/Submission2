...
public class TvshowsData {
    ...
    public static String[][] string_data = new String[][]{
            ...
            {"Arrow",
                    ...
                    "Greg Berlanti",
                    "42 minutes",
                    "https://www.youtube.com/watch?v=D5J9h0HPklE",
                    "TV-16",
            ...
            {"Black Mirror",
                    "2011",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/pXeuSWSKgWUnhRFHZ4TjAUU8lbE.jpg",
                    "Charlie Brooker",
                    "55 minutes",
            ...
            {"Family Guy",
                    ...
                    "Seth McFarlane",
                    "22 minutes",
                    "https://www.youtube.com/watch?v=lJbaVsF3Asc",
                    "TV-14",
                    "Animation, Comedy",
                    "65",
            ...
            {"Friends",
                    "1994",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/7buCWBTpiPrCF5Lt023dSC60rgS.jpg",
                    "David Crane",
                    "22 minutes",
                    "https://www.youtube.com/watch?v=ekYGfU0XIx0",
                    "TV-14",
                    "Comedy",
                    "79",
            ...
            {"How I Met Your Mother",
                    "2005",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/izncB6dCLV7LBQ5MsOPyMx9mUDa.jpg",
                    "Carter Bays",
                    "22 minutes",
            ...
            {"NCIS",
                    "2003",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/eoj15m14Zpf2bUWXqNIs7itZK9w.jpg",
                    "Don McGill",
                    "45 minutes",
            ...
            {"Silicon Valley",
                    "2014",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/dc5r71XI1gD4YwIUoEYCLiVvtss.jpg",
                    "Mike Judge",
                    "28 minutes",
            ...
            {"Supergirl",
                    ...
                    "Greg Berlanti",
                    "42 minutes",
                    "https://www.youtube.com/watch?v=49RZx5tUKM4",
                    "TV-PG",
                    "Superhero, Fantasy, Drama",
                    "58",
            ...
            {"The Office",
                    "2005",
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/qWnJzyZhyy74gjpSjIXWmuk0ifX.jpg",
                    "Ricky Gervais",
                    "20 minutes",
            ...
            {"The Simpsons",
                    ...
                    "Matt Groening",
                    "22 minutes",
                    "https://www.youtube.com/watch?v=pzdnq1zFvOY",
                    "TV-PG",
                    "Animation, Comedy",
                    "71",
            ...
            {"The Umbrella Academy",
                    ...
                    "Steve Blackman",
                    "60 minutes",
                    "https://www.youtube.com/watch?v=oFYz2cvMDqI",
                    "TV-14",
                    "Adventure, Fantasy",
                    "77",
    ...
    public static ArrayList<Tvshow> getListData() {
        ...
        for (String[] aData : string_data) {
            ...
            tvshow.setReleasedYear(aData[1]);
            tvshow.setPoster(aData[2]);
            tvshow.setDirector(aData[3]);
            tvshow.setRuntime(aData[4]);
            tvshow.setTrailer(aData[5]);
            tvshow.setRating(aData[6]);
            tvshow.setGenre(aData[7]);
            tvshow.setScore(Integer.parseInt(aData[8]));
